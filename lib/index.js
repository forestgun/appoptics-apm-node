...
if (env.APPOPTICS_APM_CONFIG_NODE) {
  log.warn('APPOPTICS_APM_CONFIG_NODE => ', env.APPOPTICS_APM_CONFIG_NODE)
...
const defaults = {
  global: {
    ...
    insertTraceIdsIntoMorgan: true,    // separate setting because this mucks with log formats directly
...
//
// the traceMode must be valid (undefined is mapped to default)
//
